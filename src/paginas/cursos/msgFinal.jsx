        ...
        <div className="container container-message">
            <div className="row">
                <div className="thanks-box">
                    <If mostrar={props.paymentMode === 'boleto'}>
                            ...
                            <div className="thanks-content">
                                <div className="thanks-billet">
                                    <div className="thanks-instructions">
                                        <p>
                                            Olá <b>{props.nome}</b>, sua compra foi registrada e aqui está o seu Boleto
                                            para ser pago. Você deve pagar o boleto em qualquer agência bancária, casa
                                            lotérica, ou através do seu internet banking.
                                        </p>
                                    </div>
                                    {/*<div>*/}
                                    ...
                                    <div className="box">
                                        <div>
                                            <a id="saveAndDownloadBillet" target="_blank" className="action-button"
                                               href={props.link}>Baixar o boleto</a>
                                    ...
                                    <p>
                                        Em alguns casos o serviço de email utilizado por você pode se enganar e colocar
                                        uma de nossas mensagens no SPAM. Por isto, pedimos que sempre verifique também a
                                        sua caixa de SPAM, pois quando seu pagamento for aprovado seus dados de acesso
                                        podem cair lá!
                                    </p>
                                    <p>
                                        Caso já tenha se passado mais de 72h que você efetuou o pagamento e ainda não
                                        recebeu seus dados de acesso, por gentileza, entre em contato através dos nossos
                                        canais de atendimento para que possamos verificar esta situação.
                                    </p>
                                </div>
                            </div>
                        </div>
                    </If>
                    <If mostrar={props.paymentMode === 'cartao'}>
                        <div className="thanks-header">
                            <header data-v-2a4dd70f="" className="thanks-header">
                                <div className="thanks-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="88" height="88" viewBox="0 0 88 88">
                                ...
                                <div className="thanks-text">
                                    <h1>Parabéns</h1>
                                    <div>
                                        <h2 data-v-2a4dd70f="">Sua compra foi efetuada com sucesso!</h2>
                                    </div>
                                </div>
                            </header>
                            <div className="transaction-code">
                            ...
                            <div className="thanks-content">
                                <div className="thanks-billet">
                                    <p>Olá <b>{props.nome}</b>, sua compra foi efetuada com sucesso estaremos enviando
                                        para o email
                                        informado os dados de acesso. Em alguns casos o serviço de email utilizado por
                                        você pode se enganar e colocar
                                        uma de nossas mensagens no SPAM. Por isto, pedimos que sempre verifique também a
                                        sua caixa de SPAM, pois seus dados de acesso podem cair lá!
                                    </p>
                                    <p>
                                        Caso já tenha se passado mais de 72h que você efetuou o pagamento e ainda não
                                        recebeu seus dados de acesso, por gentileza, entre em contato através dos nossos
